    ...
    render() {
        ...
        return (
            <Navbar collapseOnSelect className="p-3" bg="light" expand="lg" style={{ fontWeight: 'bold' }}>
                <Container>
                    <Navbar.Brand as={Link} to='/' className="text-success" style={{ fontSize: '24px' }}>Credit Application System</Navbar.Brand>
                        ...
                        {isUserLoggedIn === false ?
                            <Nav>
                                <Nav.Link as={Link} to='/login'>
                                    <Button variant="outline-success" style={{ fontWeight: 'bold' }}>Login</Button>
                                </Nav.Link>
                            </Nav>
                            :
                            <Nav>
                                <Dropdown>
                                    <Dropdown.Toggle variant="outline-success" id="dropdown-basic" style={{ fontWeight: 'bold' }}>
                                        System User
                                    </Dropdown.Toggle>
